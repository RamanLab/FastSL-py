...
def generate_elilist_xml_from_model(model):
    '''
    Generates .xml file for the elimination list used for analysis of synthetic
    lethals for a given model
    '''
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generation of elimination list\
                                                  .xml file for a genome-wide\
